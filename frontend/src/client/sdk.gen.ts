...
export class CanvasService {
  ...
  public static getCourseModules(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/canvas/courses/{course_id}/modules",
      path: {
  ...
  public static getModuleItems(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/canvas/courses/{course_id}/modules/{module_id}/items",
      path: {
        course_id: data.courseId,
  ...
  public static getPageContent(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/canvas/courses/{course_id}/pages/{page_url}",
      path: {
        course_id: data.courseId,
  ...
  public static getFileInfo(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/canvas/courses/{course_id}/files/{file_id}",
      path: {
        course_id: data.courseId,
        file_id: data.fileId,
      },
...
export class QuestionsService {
  ...
  public static getQuestion(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/questions/{quiz_id}/{question_id}",
      path: {
        quiz_id: data.quizId,
...
export class QuizService {
  ...
  public static uploadManualModule(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/quiz/manual-modules/upload",
  ...
  public static triggerContentExtraction(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/quiz/{quiz_id}/extract-content",
      path: {
        quiz_id: data.quizId,
      },
      errors: {
  ...
  public static triggerQuestionGeneration(
    ...
    return __request(OpenAPI, {
      method: "POST",
      url: "/quiz/{quiz_id}/generate-questions",
      path: {
        quiz_id: data.quizId,
      },
      errors: {
  ...
  public static getQuizQuestionStats(
    ...
    return __request(OpenAPI, {
      method: "GET",
      url: "/quiz/{quiz_id}/questions/stats",
      path: {
        quiz_id: data.quizId,
      },
      errors: {
